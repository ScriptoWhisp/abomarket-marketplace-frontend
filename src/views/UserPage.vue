            ...
            <div class="border-b border-gray-900/10 pb-12">
              ...
              <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-2">
                ...
                <div class="col-span-2">
                  ...
                  <div class="mt-2">
                    <input v-model="location" id="location" name="location" type="text" class="block w-full rounded-md border-0 p-2.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6" />
                  </div>
                </div>
              </div>
            </div>
