  ...
  <div class="bg-white min-h-dvh px-5 sm:px-20">
    <div class="grid lg:grid-cols-7 grid-cols-1 gap-3 p-10 justify-center">
      <button
          ...
          :class="{
          'bg-blue-200': selectedCategory === 'users',
          'bg-gray-100': selectedCategory !== 'users'
        }"
      ...
      <button
          ...
          :class="{
          'bg-blue-200': selectedCategory === 'orders',
          'bg-gray-100': selectedCategory !== 'orders'
        }"
          class="group hover:bg-gray-200 rounded-lg"
      >
      ...
      <button
          ...
          :class="{
          'bg-blue-200': selectedCategory === 'products',
          'bg-gray-100': selectedCategory !== 'products'
        }"
          class="group hover:bg-gray-200 rounded-lg"
      >
      ...
      <button
          ...
          :class="{
          'bg-blue-200': selectedCategory === 'statuses',
          'bg-gray-100': selectedCategory !== 'statuses'
        }"
          class="group hover:bg-gray-200 rounded-lg"
      >
      ...
      <button
          ...
          :class="{
          'bg-blue-200': selectedCategory === 'categories',
          'bg-gray-100': selectedCategory !== 'categories'
        }"
          class="group hover:bg-gray-200 rounded-lg"
      >
    ...
    <div class="grid grid-cols-1 gap-y-3 p-10">
      <a
          ...
          :key="obj.id"
          class="group bg-gray-100 rounded-lg"
      >
        ...
        <TransitionRoot as="template" :show="openManage">
          <Dialog class="relative z-10" @close="openManage = false">
                ...
                <TransitionChild as="template" enter="ease-out duration-300" enter-from="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95"
                  ...
                  <DialogPanel class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                    <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                      <div class="sm:flex sm:items-start w-full">
                        <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left w-full">
                          ...
                          <!-- Пример формы с динамическими полями -->
                            ...
                            >
                              ...
                              <div class="mt-2">
                                <input
                                    ...
                                    :type="field.type"
                                    class="block w-full rounded-md border-0 p-2.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400
                    ...
                    <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                      <button type="button"
                              class="inline-flex w-full justify-center rounded-md bg-black px-3 py-2 text-sm font-semibold text-white shadow-sm sm:ml-3 sm:w-auto"
                              @click="updateItem">
                        Update
                      </button>
                      <button type="button"
        ...
        <div class="flex min-w-0 min-h-12 gap-y-4 m-2">
          ...
          <div class="flex min-w-0 min-h-12 gap-y-4 m-2 gap-2">
            ...
            <button class="group text-gray-900 hover:text-white hover:bg-red-500 border-2 border-red-500 rounded-lg"
